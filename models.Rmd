...
**IMPORTANT** 0 values not allowed for gamma, add 1
Since our Y variable is skewed, lets try a non normal distribtion


```{r warning=FALSE, results="hide"}
traindataGAMMA <- traindata2
traindataGAMMA$goal_ratio <- traindataGAMMA$goal_ratio + 1
gmod<-glm(goal_ratio~.,family=Gamma(link=identity),traindataGAMMA)
